(function(global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    global.number_format = mod.exports;
  }
})(this, function(
  exports,
  _extends2,
  ...
  var propTypes = {
    thousandSeparator: _propTypes2.default.oneOfType([
    ...
    mask: _propTypes2.default.oneOfType([
      _propTypes2.default.string,
  ...
  var NumberFormat = (function(_React$Component) {
    ...
    function NumberFormat(props) {
      ...
      var _this = (0, _possibleConstructorReturn3.default)(
        this,
        (
          NumberFormat.__proto__ || (0, _getPrototypeOf2.default)(NumberFormat)
        ).call(this, props)
      );
    ...
    (0, _createClass3.default)(NumberFormat, [
          ...
          if (firstDecimalIndex !== -1) {
            num =
              ...
              num
                ...
                .replace(
                  new RegExp((0, _utils.escapeRegExp)(decimalSeparator), "g"),
                  ""
                );
          }
        ...
        value: function getNumberRegex(g, ignoreDecimalSeparator) {
          ...
          return new RegExp(
            "\\d" +
              ...
              !format
                ? "|" + (0, _utils.escapeRegExp)(decimalSeparator)
                : ""),
            g ? "g" : undefined
          );
        }
      ...
      },
      {
        ...
        value: function correctCaretPosition(value, caretPos, direction) {
          ...
          if (
            format[caretPos] === "#" &&
            (0, _utils.charIsNumber)(value[caretPos])
          )
            return caretPos;
          ...
          if (
            format[caretPos - 1] === "#" &&
            (0, _utils.charIsNumber)(value[caretPos - 1])
          )
            return caretPos;
          ...
          var goToLeft =
            !(0, _utils.charIsNumber)(value[caretRightBound]) ||
          ...
          if (goToLeft) {
            ...
            return (0, _utils.charIsNumber)(value[caretLeftBound])
              ? caretLeftBound + 1
              : caretLeftBound;
          }
      ...
      },
      {
        ...
        value: function formatAsNumber(numStr) {
          ...
          if (decimalScale !== undefined)
            afterDecimal = (0, _utils.limitToScale)(
              afterDecimal,
              decimalScale,
              fixedDecimalScale
            );
      ...
      },
      {
        ...
        value: function formatValueProp() {
          ...
          if (isNumericString && !format && typeof decimalScale === "number") {
            value = (0, _utils.roundToPrecision)(
              value,
              decimalScale,
              fixedDecimalScale
            );
      ...
      },
      {
        ...
        value: function correctInputValue(caretPos, lastValue, value) {
          ...
          var _findChangedIndex = (0, _utils.findChangedIndex)(
              lastValue,
              value
            ),
        ...
        */
          ...
          if (!format) {
            ...
            var _splitDecimal2 = (0, _utils.splitDecimal)(
                numericString,
                allowNegative
              ),
              beforeDecimal = _splitDecimal2.beforeDecimal,
              afterDecimal = _splitDecimal2.afterDecimal,
              addNegation = _splitDecimal2.addNegation;
      ...
      },
      {
        ...
        value: function onChange(e) {
          ...
          var currentCaretPosition = Math.max(
            el.selectionStart,
            el.selectionEnd
          );
          ...
          if (formattedValue !== lastValue) {
            this.setState(
              { value: formattedValue, numAsString: numAsString },
              function() {
          ...
          if (!format) {
            ...
            if (formattedValue !== lastValue) {
              ...
              this.setState(
                { value: formattedValue, numAsString: numAsString },
                function() {
                  var valueObj = _this2.getValueObject(
                    formattedValue,
                    numAsString
                  );
                  props.onValueChange(valueObj, e);
        ...
        value: function onKeyDown(e) {
          ...
          */
            if (
              ...
              this.setState(
                { value: newValue, numAsString: _numAsString2 },
                function() {
                  _this3.setPatchedCaretPosition(
                    el,
                    newCaretPosition,
                    newValue
                  );
      ...
      },
      {
        ...
        value: function onFocus(e) {
          ...
          setTimeout(function() {
            ...
            var caretPosition = _this4.correctCaretPosition(
              value,
              selectionStart
            );
            if (caretPosition !== selectionStart) {
